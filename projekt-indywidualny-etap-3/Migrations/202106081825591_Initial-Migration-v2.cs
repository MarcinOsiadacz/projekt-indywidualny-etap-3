namespace projekt_indywidualny_etap_3.Migrations
{
    ...
    public partial class InitialMigrationv2 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Categories", t => t.EventCategoryId, cascadeDelete: true)
                .ForeignKey("dbo.Types", t => t.EventTypeId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Events", "EventTypeId", "dbo.Types");
            DropForeignKey("dbo.Events", "EventCategoryId", "dbo.Categories");
